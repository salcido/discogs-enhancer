module.exports = {
  ...
  previous: [
    ...
    },
    {
      ...
      thanks: ['Huge thank you to Joe McCormick for the donation!'],
    },
    {
      version: '3.2.0',
      features: [
    ...
    },
    {
      ...
      updates: [
        {
          name: 'Bug Fix',
          description: 'Fixed an issue where Suggested Prices would not show an error if you were not registered as a Seller.'
        },
      ],
    ...
    },
    {
      ...
      updates: [
        ...
        {
          name: 'Bug Fix',
          description: 'Fixed an issue where the Feedback Notifications would not be shown in some instances.'
        }
      ],
    ...
    },
    {
      ...
      updates: [
        {
          name: 'Bug Fix',
          description: 'More Dark Theme fixes to work with the new Version Finder'
        }
      ],
    ...
    },
    {
      ...
      updates: [
        {
          name: 'Bug Fix',
          description: 'Fixed an issue with Inventory Scanner.'
        }
      ],

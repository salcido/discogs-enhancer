...
rl.ready(() => {
  ...
  let user = rl.username(),
      ...
      selector = reactVersion ? 'div[class^="profile_"]' : '#activity_menu',
      position = reactVersion ? 'afterbegin' : 'beforeend',
      elem = reactVersion ? 'div' : 'li',
      inline_css = reactVersion ? 'padding-top: 1.25rem; padding-right: 1.5rem;' : '',
